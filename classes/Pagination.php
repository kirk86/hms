...
class Pagination
{
    ...
    public function paginate()
    {
        ...
        if ($this->num_pages > 10)
        {
            $this->return = ($this->current_page != 1 && $this->total_items >= 10) ?
                "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&laquo; Previous</a> " : "<span class=\"inactive\" href=\"#\">&laquo; Previous</span> ";
            ...
            $this->return .= (($this->current_page != $this->num_pages && $this->
                ...
                "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Next &raquo;</a>\n" : "<span class=\"inactive\" href=\"#\">&raquo; Next</span>\n";
    ...
    public function displayJumpMenu()
    {
        ...
        return "<span class=\"paginate\">Page:</span><select class=\"paginate\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$this->option</select>\n";
    }
