...
<div class="mainbar">
         <?php
          ...
          $pagination->paginate();
          echo "<br />Total Patient Lab Test : <b>$total_count[0]</b> <br /><br /><br />";
           ...
           <table id="plabtest" class="sortable resizable editable">
				...
				<tbody id="plabtest_body">
                  ...
                  ?>
                    ...
                    <a class="delete" href="#" onClick="deleteRecord(<?php echo $row['id_plabtest']; ?>); return false">delete</a>
                    </td>
                  ...
                  else
                  {
                    ...
                    <font color='red'>All Patient Lab Test Deleted</font>
                    </td></tr>";
                  }
                  DB::Close();
                  ?>
...
/*  function addUser() {
  ...
  function deleteRecord( id_record ) {
    ...
    var answer = confirm('Are you sure you want to delete this patient lab test?');
    if (answer) {
