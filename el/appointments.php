...
function init() {
        ...
        scheduler.config.auto_end_date = true;
         ...
         scheduler.attachEvent("onEventSave",function(id,data){
			if (!data.text) {
				alert("Το κείμενο δεν πρέπει να είναι κενό");
				return false;
			}
			if (data.text.length<8) {
				alert("Κείμενο πολύ μικρό");
				return false;
			}
			return true;
		});
	    ...
	    scheduler.locale.labels.section_location="Τοποθεσία";
        scheduler.locale.labels.section_type="Ιατρός";
