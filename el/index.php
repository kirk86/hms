...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="searchform">
           ...
           <!--<input type="image" src="images/search_btn.gif" name="ToDo" id="ToDo"  class="button_search" value="<?php //echo md5("patient_search"); ?>" />-->
    ...
    ?>
      ...
      <div class="sidebar">
        <div class="searchform">
          <?php echo (isset($_SESSION['id_employee']) && !empty($_SESSION['id_employee'])) ? "<img src='images/userpic.gif' align='top' />&nbsp;Καλωσήλθατε ".$_SESSION['firstname']." ".$_SESSION['lastname']."!&nbsp;&nbsp;<a href='index.php?ToDo=logout'>(Έξοδος)</a>" : ""; ?>
        </div>
