...
class ErrorHandler
{
    ...
    public static function Handler($errNo, $errStr, $errFile, $errLine)
    {
        ...
        if (($errNo == E_WARNING && IS_WARNING_FATAL == false) || ($errNo == E_NOTICE ||
            $errNo == E_USER_NOTICE)) // If the error is nonfatal ...
        ...
        } else // If error is fatal ...
		{
            ...
            if (DEBUGGING == true)
                ...
                echo SITE_GENERIC_ERROR_MESSAGE; // Stop processing the request
            exit();
        }
    }
