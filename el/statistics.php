...
<script type="text/javascript">
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					title: {
						text: 'Μηνιαία Έσοδα και Έξοδα',
						style: {
							margin: '10px 0 0 0' // center it
						}
					},
					subtitle: {
						text: 'Μισθοί Ιατρών και Χρεώσεις Ασθενών',
						style: {
			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
				    ...
				    series: [{
						type: 'pie',
						name: 'Ετήσια Έσοδα και Έξοδα',
						data: [
							['Εργαστηριακές Εξετάσεις', <?php echo $plabtestExpense; ?>],
							['Αγορές Φαρμάκων', <?php echo $pharmacyExpense; ?>],
							{
								name: 'Μισθοί Ιατρών',    
							...
							['Χρεώσεις Ασθενών', <?php echo $patientExpense; ?>]
						]
					}]
				});
			});
